...
const JobAnalysis = () => {
    ...
    const handleFinalize = async () => {
        ...
        try {
            ...
            setLoadingMessage('Create resume for Job posting based on the selected baseline resume...completed\nRunning AI rewrite of resume (can take several minutes)...');

            // Step 2: AI rewrite the resume
            const rewriteResponse = await apiService.rewriteResume(id);

            setLoadingMessage('Create resume for Job posting based on the selected baseline resume...completed\nRunning AI rewrite of resume (can take several minutes)...completed');
