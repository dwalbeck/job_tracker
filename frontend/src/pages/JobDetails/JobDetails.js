        ...
        <div className="details-main-section">
          <div className="details-left-column">
            ...
            <div className="detail-row">
              ...
              <span className="detail-value">{job.date_applied ? new Date(job.date_applied).toLocaleDateString() : 'Not specified'}</span>
            </div>

            <div className="detail-row">
              <span className="detail-label">Last Contact:</span>
              <span className="detail-value">{job.last_contact ? new Date(job.last_contact).toLocaleDateString() : 'None'}</span>
            </div>

            <div className="detail-row">
              <span className="detail-label">Job Created:</span>
              <span className="detail-value">{job.job_created ? new Date(job.job_created).toLocaleDateString() : 'Not specified'}</span>
            </div>
          ...
          <div className="details-right-buttons">
            ...
            {job.resume_id && (
              <>
                ...
                <button onClick={handleCreateCoverLetter} className="url-action-button create-cover-letter-button">
                  Create Cover Letter
                </button>
              </>
            )}
                ...
                >
                  <div className="note-card-row">
                    <div className="note-card-field">
                      ...
                      <span className="note-card-value">{formatNoteCreated(note.note_created)}</span>
                    </div>
                    <div className="note-card-field">
