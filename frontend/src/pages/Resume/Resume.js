...
const Resume = () => {
  ...
  const handleEdit = (resumeId) => {
    // Navigate to edit form - placeholder for now
            ...
            {filteredBaselineResumes.length === 0 ? (
              ...
              filteredBaselineResumes.map((resume) => (
                <div key={resume.resume_id} className="resume-card">
                  <div className="resume-card-title clickable" onClick={() => handleViewResume(resume.resume_id)}>
                    {resume.resume_title}
                  </div>
                  ...
                  <div className="resume-card-row">
                    <div className="resume-card-action" onClick={() => handleClone(resume.resume_id)}>
                      <span className="action-icon">📄</span>
                      <span className="action-label">Clone</span>
                    </div>
                    <div className="resume-card-action" onClick={() => handleDelete(resume.resume_id)}>
                  ...
                  <div className="resume-card-row">
                    <div className="resume-card-action" onClick={() => handleEdit(resume.resume_id)}>
                      <span className="action-icon">⚙️</span>
                      <span className="action-label">Edit</span>
                    </div>
                    {!resume.is_default && (
                      <div className="resume-card-action" onClick={() => handleSetDefault(resume.resume_id)}>
                        <span className="action-icon">⭐</span>
            ...
            {filteredJobResumes.length === 0 ? (
              ...
              filteredJobResumes.map((resume) => (
                <div key={resume.resume_id} className="resume-card job-resume-card">
                  ...
                  <div className="resume-card-row">
                    <div className="resume-card-action" onClick={() => handleClone(resume.resume_id, false)}>
                      <span className="action-icon">📄</span>
                      <span className="action-label">Clone</span>
                    </div>
                    <div className="resume-card-action" onClick={() => handleTailor(resume.job_id, resume.baseline_resume_id)}>
                      <span className="action-icon">✏️</span>
                  ...
                  <div className="resume-card-row">
                    <div className="resume-card-action" onClick={() => handleDelete(resume.resume_id, false)}>
                      <span className="action-icon">🗑️</span>
                      <span className="action-label">Delete</span>
                    </div>
                  </div>
